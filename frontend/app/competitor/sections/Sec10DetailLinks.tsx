...
import { VERTICAL_PEER_COMPANIES, verticalReportHref } from "../lib/vertical_navigation";
import type { SectionProps } from "../lib/section_ui";

export function Sec10DetailLinks(_props: SectionProps) {
  return (
    <ChapterPanel
      sectionId="sec-10"
      slides={[
          ...
          content: (
            <div className="mx-auto max-w-3xl space-y-6">
              ...
              <ul className="grid gap-3 sm:grid-cols-2">
                {VERTICAL_PEER_COMPANIES.map((co, i) => {
                  const accent = colorForCompany(co.id);
                  return (
