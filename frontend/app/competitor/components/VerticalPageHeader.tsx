...
export function VerticalPageHeader({ report, activeSnapId, onNavigate }: Props) {
  return (
    <div className="competitor-page-header shrink-0 px-6 pb-3 pt-6 md:px-8 md:pt-8">
      <div className="flex items-center justify-between gap-4">
        ...
        {report ? <VerticalProgressScale report={report} activeSnapId={activeSnapId} onNavigate={onNavigate} /> : null}
      </div>
    </div>
  );
}
