...
- **竞品财报（1.2.3.c）**：侧栏 `/competitor`（须 `view_business_dashboard`：管理层/财务部/管理员）；数据来自财务后台上传的行业财报汇析 Markdown，见 [specs/features/1.2.3.c-竞品财报可视化.md](specs/features/1.2.3.c-竞品财报可视化.md)。
